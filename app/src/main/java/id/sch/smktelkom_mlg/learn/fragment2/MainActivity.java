...
public class MainActivity extends AppCompatActivity {
    ...
    private void changeFragment(int no) {
        ...
        switch (no){
            case 1 : fragment = View1Fragment.newInstance(
                    R.drawable.ic_brightness_5_black_24dp,"Sun"); break;
            case 2 : fragment = View1Fragment.newInstance(
                    R.drawable.ic_brightness_2_black_24dp,"Moon"); break;
            case 3 : fragment = View1Fragment.newInstance(
                    R.drawable.ic_wb_cloudy_black_24dp,"Cloud"); break;
        }
